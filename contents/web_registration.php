...
?>
 ...
 <?php require_once "htmlHeadForContents.php"; ?>
  ...
  <div class="container">
     <h4 class="bold text-center text-uppercase yooo" style="margin-top:50px;">Web Development Training Registration</h4>
     <div class="row">
        <div class="well col-sm-6 col-sm-offset-3">
            ...
            <?php if($hasRegistered): ?>
                <div class="alert alert-info">
                    <a href="#" data-dismiss="alert" class="close">&times;</a>
                    <div><strong>Alert!</strong> You have already registered. Go and pay your first and second installments.</div>
                </div>
            <?php endif ?>
            <form action="backend/webRegistration.php" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select placeholder="Select your Sex" value="<?php echo $sex ?>" name="sex" class="form-control">
                            <option class="disabled" value="">Select your Gender</option>
                ...
                <div class="form-group">
                    <input type="hidden" name="feesType" value="webRegistration">
                </div>
                <div class="form-group">
            ...
            <p class="text-center">
                <a href="web_login.php" style="color:#35424a;">Pay Installments</a>
            </p>
        </div>
     </div>
