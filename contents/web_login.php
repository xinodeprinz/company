<?php
   ...
   require_once "functions.php"; 
    ...
    $registered_students = SelectMultipleRecords('web_register', $pdo);
   ...
   if($_SERVER['REQUEST_METHOD'] === 'POST'){
       ...
       if(!$error){
           foreach($registered_students as $RS){
               if($RS['Name'] === strtoupper($name) && $RS['Date_of_Birth'] === DateOfBirth($_POST['dob']) && $RS['Phone'] === $contact){
                   $hasRegistered = true;
                   $_SESSION['name'] = $name;
...
?>
 ...
 <?php require_once "htmlHeadForContents.php"; ?>
  ...
  <br><hr><div class="container">
     <h4 class="bold text-center text-uppercase yooo">Login into Web Development Account</h4>
     <p class="alert alert-warning">
        <a href="#" data-dismiss="alert" class="close">&times;</a>
         Only students who have registered for the web development classes can login. If you haven't registered yet then click on the register link below to register.
    </p>
     ...
     <div class="row">
        <div class="well col-sm-6 col-sm-offset-3">
            ...
            <p class="text-center"><a href="web_registration.php" style="color:#35424a;">Register</a></p>
        </div>
     </div>
